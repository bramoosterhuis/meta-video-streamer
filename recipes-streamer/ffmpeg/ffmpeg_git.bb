...
SRC_URI = "git://git.bybram.com/community/ffmpeg-with-ndi-support.git \
           "
SRCREV = "ddf0e880417664e298bf01669cf1b599ff924857"
...
PACKAGECONFIG ??= "avdevice avfilter avcodec avformat swresample swscale postproc avresample \
                   alsa bzlib gpl lzma theora x264 zlib nonfree omx ndi omx-rpi mmal srt \
...
PACKAGECONFIG[ndi] = "--enable-libndi_newtek,,ndi-sdk"
PACKAGECONFIG[omx] = "--enable-omx,,userland"
PACKAGECONFIG[omx-rpi] = "--enable-omx-rpi,,userland"
PACKAGECONFIG[mmal] = "--enable-mmal,,userland"
PACKAGECONFIG[nonfree] = "--enable-nonfree,,"
PACKAGECONFIG[srt] = "--enable-libsrt,,libsrt"
...
EXTRA_OECONF = " \
    ...
    --extra-cflags="${CFLAGS} ${HOST_CC_ARCH}${TOOLCHAIN_OPTIONS} -I${STAGING_DIR_TARGET}/usr/include/IL" \
